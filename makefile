...
LIBS_LOCAL_BASE  := lib
LIBS_LOCAL       := Adafruit_PWM_Servo_Driver_Library Bounce2 EncoderTool MD_MIDIFile SdFat SPI SSD1306Ascii Wire TeensyTimerTool 

CORE_BASE        := C:\PROGRA~1\Arduino\ARDUIN~1.12\hardware\teensy\avr\cores\teensy3
GCC_BASE         := C:\PROGRA~1\Arduino\ARDUIN~1.12\hardware\tools\arm\bin
...
DEFINES     := -D__MK66FX1M0__ -DTEENSYDUINO=153 -DARDUINO_TEENSY36 -DARDUINO=10807
